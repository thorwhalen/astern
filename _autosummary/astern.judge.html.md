...
which is exactly the dependent variable the cost model in [`astern.estimate`](astern.estimate.html.md#module-astern.estimate)
...
- `--json-schema` is honoured and the parsed object lands under
  ...
  is what makes the regression in [`astern.estimate`](astern.estimate.html.md#module-astern.estimate) a straight line.
