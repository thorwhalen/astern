...
`telemetry=False` stops PostHog reporting. See [`astern.entire.entire_enable()`](astern.entire.html.md#astern.entire.entire_enable).
...
See [`astern.entire.entire_status()`](astern.entire.html.md#astern.entire.entire_status) for the full field list, including
...
`strict_schema` (default `False`, see [`astern.judge`](astern.judge.html.md#module-astern.judge)) passes the
